...
const SUPPORTED_PROVIDERS: ProviderDef[] = [
  {
    ...
    helpText:
      'Default provider — routes enrichment, summaries, and decisions through the Vercel AI Gateway (default model: google/gemini-2.5-flash-lite). Key starts with vck_.',
  ...
  },
  {
    ...
    helpText:
      'Bring-your-own-key alternative. One key unlocks every model (Anthropic, OpenAI, Google, Mistral, …). Activated automatically when only OpenRouter is configured; otherwise set WORKGRAPH_AI_PROVIDER=openrouter to force-use.',
    supportsBaseUrl: true,
  },
];
