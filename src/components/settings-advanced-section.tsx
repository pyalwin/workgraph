            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-[0.78rem] text-[#999] mt-[2px] mb-4">
                  Workspaces decide which product modules are visible. Engineering can expose Projects; a custom Otti workspace can expose Otti.
                </div>
